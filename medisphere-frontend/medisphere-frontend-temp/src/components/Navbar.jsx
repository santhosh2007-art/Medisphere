  ...
  return (
    <nav style={styles.nav}>
      ...
      <div style={styles.rightSection}>
        {/* Sandbox Toggler */}
        <div style={{ ...styles.sandboxWidget, borderColor: sandboxMode ? '#b45309' : '#047857' }}>
          <div style={styles.sandboxLabel}>
            {sandboxMode ? (
              <>
                <Database size={16} color="#fbbf24" />
                <span style={{ color: '#fbbf24' }}>Sandbox Mode</span>
              </>
            ) : (
              <>
                <Server size={16} color="#34d399" />
                <span style={{ color: '#34d399' }}>Keycloak Live</span>
              </>
            )}
          </div>
          <button 
            onClick={() => toggleSandbox(!sandboxMode)} 
            style={styles.toggleBtn}
            title={sandboxMode ? "Switch to Live Keycloak Connection" : "Switch to Offline Sandbox Mode"}
          >
            {sandboxMode ? (
          ...
          <div style={styles.userCard}>
            ...
            <div style={styles.userInfo}>
              ...
              <span style={styles.userRole}>
                {user.roles?.includes('PROVIDER') ? 'Clinician' : 'Staff'}
              </span>
            </div>
